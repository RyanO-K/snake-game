...
- Name: snake.spec.ts >> Page load >> game status is IDLE on load
- Location: tests\snake.spec.ts:57:7
...
Locator: locator('[data-game-status="IDLE"]')
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('[data-game-status="IDLE"]')
